...
const About = () => {
  ...
  >
    I'm a passionate full-stack developer currently focused on building modern,
    responsive web apps with the <span className="text-[#A27B5C] font-medium">MERN stack</span>. 
    I love turning complex problems into simple, elegant solutions. Currently crafting
    projects that combine backend APIs, frontend UI/UX, and real-world deployment.
  </motion.p>
